...
#include <libant/logger/fmt/format-inl.h>
...
typename basic_format_context<std::back_insert_iterator<buffer<Char>>, Char>::iterator
...
template basic_format_context<std::back_insert_iterator<buffer<char>>, char>::iterator
